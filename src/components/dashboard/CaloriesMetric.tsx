...
import type { DateRange } from '../../utils/dateRangeCalculations';
...
export function CaloriesMetric({
  ...
  const totalTargetCalories = dailyTarget * dateRangeInfo.daysInPeriod;
  const remainingCalories = totalTargetCalories - totalCalories;
  const averageRemainingCalories = dateRangeInfo.remainingDaysForLogs > 0
    ? Math.round(remainingCalories / dateRangeInfo.remainingDaysForLogs)
    : 0;
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="space-y-6">
        ...
        {dateRangeInfo.remainingDaysForLogs > 0 && (
          <div className="bg-orange-50 rounded-lg p-4">
            ...
            <div className="text-sm text-orange-700 mt-1">
              {dateRangeInfo.remainingDaysForLogs} day{dateRangeInfo.remainingDaysForLogs !== 1 ? 's' : ''} remaining
            </div>
          </div>
        )}
      </div>
